...
class Lexer:
    ...
    def analyze(self, lines: str) -> list:
        ...
        self.__second_sweep() # Convert everything into a list of instructions [["DECLARE", ["A", 5], 1], ["PRINT", ["Hello"], 4], ...]
    ...
    def __first_sweep(self): # This will remove comments, tabs, empty lines, lines before START and after END, and check for a START and END lines.
        ...
        self.lines = Extras.get_lines_between(self.lines, Syntax.SCRIPT_START, Syntax.SCRIPT_END)
